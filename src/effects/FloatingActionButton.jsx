  ...
  return (
    <div className="fixed bottom-5 right-5 z-40 md:bottom-6 md:right-6">
      ...
      <motion.button onClick={() => setOpen(!open)}
        whileTap={{ scale: 0.9 }}
        className="relative w-13 h-13 md:w-14 md:h-14 bg-gradient-to-br from-indigo-500 to-purple-600 text-white rounded-2xl shadow-xl shadow-indigo-500/40 flex items-center justify-center active:scale-90 transition-all">
