...
import { uploadImageToRepo } from '../data/sync'
...
export default function ImageUpload({ urls, onChange }) {
  ...
  return (
    <div className="space-y-2">
      <label className="text-sm text-gray-400 block">Images</label>
      <div
      ...
      >
        {uploading ? (
          ...
          <div className="flex flex-col items-center gap-1.5 py-2">
            ...
            <p className="text-xs text-gray-500">Drop images here or click to browse</p>
          </div>
        )}
