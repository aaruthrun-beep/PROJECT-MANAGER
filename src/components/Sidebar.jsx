    ...
    <div className="flex flex-col h-full">
      <div className="flex items-center justify-between mb-6 px-2">
        <div>
          ...
          <p className="text-[10px] text-zinc-500 mt-0.5">Ultimate PM Dashboard</p>
        </div>
      </div>
      ...
      <div className="pt-4 mt-4 border-t border-white/5 text-center">
        <p className="text-[10px] text-zinc-600">v2.0 Ultimate</p>
      </div>
    </div>
  )
}
          ...
          <>
            ...
            <motion.aside initial={{ x: -260 }} animate={{ x: 0 }} exit={{ x: -260 }}
              ...
              <div className="flex justify-end mb-2">
                <button onClick={onMobileClose} className="text-zinc-400 hover:text-white p-1.5 rounded-lg hover:bg-zinc-800/80">
                  <X size={20} />
                </button>
              </div>
